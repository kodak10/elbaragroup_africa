               ...
               <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input style="text-transform: uppercase"  type="text" class="form-control"  name="name" value="{{ old('name', Auth::user()->client->name) }}">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <!-- Nom -->
                    <div class="form-group">
                        <label for="nom" class="col-md-4 control-label">Prénoms</label>
                        <div class="col-md-6">
                            <input id="nom" type="text" class="form-control" name="prenoms" value="{{ old('prenoms', Auth::user()->client->prenoms) }}" required autofocus>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id=" email" type="email" class="form-control" value="{{ old('email', Auth::user()->email) }}" required disabled>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="telephone" type="text" class="form-control" name="telephone" value="{{ old('telephone', Auth::user()->client->telephone) }}">
                        </div>
                    </div>
                </div>
